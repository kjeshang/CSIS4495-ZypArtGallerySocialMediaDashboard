...
# Title of webpage:
canadianCitySectionHeading = [html.H1("Facebook Audience Insights - Canadian City", style={"font-weight":"bold"})];

# Date range filter:
canadianCityDateRangeFilter = [
    html.P("Date Range", style={"font-weight":"bold"}),
    dcc.DatePickerRange(
        id="FB_canadianCity_date-range",
...
canadianCityStructure = [
    ...
    dbc.Card(children=[
        dbc.CardBody(children=[
            ...
            dbc.Row(children=[
                dcc.Tabs(children=[
                    dcc.Tab(label=audienceCanadianCityDetail[0].get("title"), children=[
                        dbc.Row(children=[canadianCityBubbleMap_1]),
                        dbc.Row(children=[canadianCityBarChart_1])
                    ]),
                    dcc.Tab(label=audienceCanadianCityDetail[1].get("title"), children=[
...
@callback(
    Output("FB_collapse-canadianCity", "is_open"),
    [Input("FB_collapse-button-canadianCity", "n_clicks")],
    [State("FB_collapse-canadianCity", "is_open")],
)
...
@callback(
    ...
    [
        Input("FB_canadianCity_date-range", "end_date"),
        Input("FB_canadianCity_subRegion", "value")
    ]
)
...
@callback(
    ...
    [
        Input("FB_canadianCity_date-range", "start_date"),
        Input("FB_canadianCity_date-range", "end_date"),
        Input("FB_canadianCity_subRegion", "value")
    ]
)
